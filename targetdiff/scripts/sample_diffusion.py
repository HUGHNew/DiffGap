...
def main(args:SampleArgs):
    ...
    logger.info(f"test_set: {test_set.indices}")
    # [3011, 5379, 5690, 6580, 7026, 7659, 7672, 9084, 15130, 15613]
    # ['BSD_ASPTE_1_130_0', 'GLMU_STRPN_2_459_0', 'GRK4_HUMAN_1_578_0', 'GSTP1_HUMAN_2_210_0', 'GUX1_HYPJE_18_451_0', 'HDAC8_HUMAN_1_377_0', 'HDHA_ECOLI_1_255_0', 'HMD_METJA_1_358_0', 'CCPR_YEAST_69_361_0', 'IPMK_HUMAN_49_416_0']
